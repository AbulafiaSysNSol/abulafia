<div class="panel panel-default">
	<div class="panel-heading">
  	...
  	<div class="panel-body">
		...
		<center>
		 	<div class="alert alert-info"><i class="fa fa-lock">
		 		</i> Ti consigliamo di inserire una password che contenga <b>almeno 6 caratteri</b> e che sia composta da <b>lettere e numeri.</b>
		 	</div>
		    ...
		    <form action="login0.php?corpus=cambio-password2" method="post" role="form">
		  		...
		  		<button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Cambia Password</button>

<?php
	...
	$update=mysql_query("UPDATE usersettings SET risultatiperpagina='$risultati_per_pagina', splash='$splash', primocoloretabellarisultati='$color1', secondocoloretabellarisultati='$color2', notificains = '$ins', notificamod = '$mod' WHERE idanagrafica='$id'");

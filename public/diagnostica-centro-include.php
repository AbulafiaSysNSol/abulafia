<?php
	if ($_SESSION['auth'] < 90) { 
		echo 'Non hai l\'autorizzazione necessaria 
			per utilizzare questa funzione. Se ritieni di averne diritto, 
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<ul>
			...
			<div id="connect" style="display: none;"><i class="fa fa-circle-o-notch fa-spin"></i> Connessione al server mail in corso...
			</div>
		</div>
	</div>

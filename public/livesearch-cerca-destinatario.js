...
function showResult(str,idlettera,conoscenza) {
	...
	var url="livesearch-cerca-destinatario.php";
	url=url+"?q="+str;
	url=url+"&idlettera="+idlettera;
	url=url+"&conoscenza="+conoscenza;
...
function stateChanged() {
	if (xmlhttp.readyState==4) {
		if(conoscenza == 0) {
			...
			document.getElementById("livesearch2").style.width="600px";
		}
	}
}

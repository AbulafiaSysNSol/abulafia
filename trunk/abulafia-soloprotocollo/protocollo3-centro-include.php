...
if( isset($arraydata[0]) ) { $lettera_data_giorno = $arraydata[0]; }
if( isset($arraydata[1]) ) { $lettera_data_mese = $arraydata[1]; }
if( isset($arraydata[2]) ) { $lettera_data_anno = $arraydata[2]; }

...
<label> <br>Risultati per Pagina:<br><input size="3" type="text" name="risultatiperpagina"  value="<?php echo $_SESSION['risultatiperpagina'];?>"/>
</label>
<br>
<br>Modifica Logo:<br>
<table border="0">
...
<br><br>
<input type="button" value="MODIFICA" onClick="Controllo()" />
</form>

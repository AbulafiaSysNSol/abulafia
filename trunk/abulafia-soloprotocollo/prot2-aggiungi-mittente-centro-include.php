...
<td>
<a href="login0.php?corpus=modifica-protocollo&from=aggiungi&tabella=lettere<?php $annoprotocollo; ?>&idanagrafica=<?php echo $row['idanagrafica'];?>&id=<?php echo $idlettera;?>&urlpdf=<?php echo $urlpdf;?>">Seleziona Mittente/Destinatario</a>
</td>
...
?> <a href="login0.php?corpus=prot2-aggiungi-mittente&idlettera=19&urlpdf=19nota n. 000025.Pdf&iniziorisultati=<?php $paginaprecedente = $iniziorisultati - $risultatiperpagina ; echo "$paginaprecedente" ;?>&cercato=<?php echo "$cercato" ;?>&tabella=<?php echo "$tabella" ;?>&currentpage=<?php $previouspage= $currentpage - 1 ; echo "$previouspage" ;?>">Pagina precedente </a> <?php } 
if (($iniziorisultati + 10) < $tot_records ) {
?>  <a href="login0.php?corpus=prot2-aggiungi-mittente&idlettera=19&urlpdf=19nota n. 000025.Pdf&iniziorisultati=<?php $paginasuccessiva = $iniziorisultati + $risultatiperpagina ; echo "$paginasuccessiva" ;?>&cercato=<?php echo "$cercato" ;?>&tabella=<?php echo "$tabella" ;?>&currentpage=<?php $nextpage= $currentpage + 1 ; echo "$nextpage" ;?>">Pagina successiva</a><?php }

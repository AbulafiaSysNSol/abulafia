<?php
	...
	if ($urlfile) {
		foreach ($urlfile as $valore) {
			...
			$intestazione = "Croce Rossa Italiana Comitato Provinciale CT - Protocollo n° ".$id;
			$pdf->Write(0, 'Croce Rossa Italiana - Comitato Provinciale Catania - Protocollo n° '.$id.' del 01/01/2014');
			$pdf->Code39(11, 12, $id.' - 01.01.2014');
